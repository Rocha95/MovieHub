...
export default function Navbar() {
  ...
  // Fecha o dropdown apenas se clicar estritamente fora do container
  useEffect(() => {
    ...
    <header className="sticky top-0 z-50 bg-cinema-black/95 backdrop-blur border-b border-cinema-surface-2 px-6 py-4">
      <div className="mx-auto max-w-6xl flex items-center justify-between gap-4">
        ...
        <nav className="flex items-center space-x-6">
          ...
          {/* Dropdown Bilheteria com suporte a clique e hover */}
          <div 
            className="relative" 
            ref={dropdownRef}
          >
            ...
            {dropdownOpen && (
              <div 
                ...
                style={{ backgroundColor: '#121212' }} // Cor sólida de fundo caso haja bug com Tailwind
              >
                <Link
