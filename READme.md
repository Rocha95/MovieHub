...
[Sobre](https://github.com/Rocha95/MovieHub/blob/f663ae668568977e627575656b3c58d85fe083cd/READme.md#-sobre-o-projeto) • [Funcionalidades](https://github.com/Rocha95/MovieHub/blob/f663ae668568977e627575656b3c58d85fe083cd/READme.md#-funcionalidades) • [Tecnologias](https://github.com/Rocha95/MovieHub/blob/f663ae668568977e627575656b3c58d85fe083cd/READme.md#%EF%B8%8F-tecnologias) • [Arquitetura](https://github.com/Rocha95/MovieHub/blob/f663ae668568977e627575656b3c58d85fe083cd/READme.md#-arquitetura) • [Como executar](https://github.com/Rocha95/MovieHub/blob/f663ae668568977e627575656b3c58d85fe083cd/READme.md#-como-executar)
...
A plataforma permite explorar informações cinematográficas, organizar uma biblioteca pessoal, criar listas, acompanhar sessões, registrar experiências através de avaliações e comentários e descobrir novos filmes através de sugestões personalizadas.

O projeto foi desenvolvido como uma forma de aplicar, na prática, conceitos de **desenvolvimento Full Stack, APIs REST, integração com serviços externos, modelagem de dados, autenticação, cache, testes automatizados, containerização e construção de interfaces modernas**.
...
* Filmes em cartaz
* Informações de provedores de streaming
...
* Busca de sessões por cidade
* Consulta de filmes em cartaz por localização
* Consulta de cinemas e horários disponíveis
* Integração com o Ingresso.com
...
* Visualização de comentários de um filme
* Associação do comentário ao usuário e ao filme
* Restrição de comentários a filmes registrados como assistidos
...
* Análise dos gêneros dos filmes assistidos
* Consideração das avaliações realizadas pelo usuário
* Exclusão de filmes já assistidos das recomendações
...
* Métricas da experiência cinematográfica
* Informações relacionadas ao histórico do usuário
...
* Redução de chamadas desnecessárias às APIs externas
* Cache de dados do TMDB
* Cache de cidades e sessões do Ingresso.com
* Cache de recomendações, provedores e bilheteria
...
* Ajustes de imagens e formulários
* Melhorias de navegação em diferentes resoluções
...
[Bilheterias-2](https://private-user-images.githubusercontent.com/14837801/651680563-7bbf0998-5ece-414a-b219-729b33508cc2.png)
...
[image](https://private-user-images.githubusercontent.com/14837801/652255538-cb94bf5c-c375-4ec8-8200-35acdf06a4fb.png)

[image](https://private-user-images.githubusercontent.com/14837801/652254182-19817610-5e90-4d5f-bcaa-8cee85f18ec1.png)
...
[image](https://private-user-images.githubusercontent.com/14837801/652256616-cb2b3116-33a0-4e78-8efc-d42450aff687.png)
...
```text
              ...
              ▼                ▼                ▼
       ┌─────────────┐  ┌─────────────┐  ┌────────────────┐
       │  TMDB API   │  │  OMDb API   │  │ Ingresso.com   │
       │ Dados de    │  │ Dados       │  │ Sessões e      │
       │ filmes      │  │ adicionais  │  │ cinemas        │
       └─────────────┘  └─────────────┘  └────────────────┘
```

**svg**

O backend centraliza as integrações externas, autenticação, regras de negócio, cache e acesso ao banco de dados.
...
Ou, alternativamente, utilizar Docker para executar o ambiente completo.
...
Consulte o arquivo `.env.example` para verificar todas as variáveis disponíveis.
...
O projeto também possui validações relacionadas à sintaxe dos arquivos JavaScript e à estrutura das integrações.
...
* Notificações de novas sessões
* Integração com mais serviços de streaming
* Melhorias no sistema de recomendações
* Recomendações utilizando Machine Learning
* Integração com serviços de IA
* Histórico detalhado de avaliações
* Sistema de favoritos para cinemas
* Melhorias na análise de hábitos cinematográficos
...
Através dele, estou explorando a integração entre **React, Node.js, PostgreSQL, Prisma, Docker e APIs externas**, buscando desenvolver não apenas funcionalidades, mas também boas práticas de arquitetura, organização, segurança, performance, testes e experiência do usuário.
...
[GitHub](https://github.com/Rocha95) ([image](https://camo.githubusercontent.com/b4ba68fb7704a954feb95308413562deb49e74feb076302abb9583785bc65774/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f4769744875622d3138313731373f7374796c653d666c6174266c6f676f3d676974687562266c6f676f436f6c6f723d7768697465))
